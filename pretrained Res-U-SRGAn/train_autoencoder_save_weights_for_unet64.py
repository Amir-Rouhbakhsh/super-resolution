...
autoencoder_model = build_autoencoder(lr_image_array.shape[1:])  # Shape of a single image
...
history = autoencoder_model.fit(
    ...
    epochs=30000,  # Set a high number of epochs, but training will stop earlier
    verbose=1, 
...
save_path = r'H:/GPU/srgan thesis/13-pretrainedunet/autoencoder_trained64.h5'
...
unet_save_path = r'H:/GPU/srgan thesis/13-pretrainedunet/unet_with_transferred_weights64.h5'
