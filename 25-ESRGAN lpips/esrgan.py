...
def build_generator(num_rrdb_blocks=16, input_shape=(64, 64, 3)):
...
def generate_sample_images(epoch, lr_images, hr_images, num_samples=1):
    ...
    for i in range(num_samples):
        ...
        # Save the figure
        sample_dir = 'H:/GPU/srgan thesis/25-ESRGAN lpips/generated_samples'
...
log_dir = 'H:/GPU/srgan thesis/25-ESRGAN lpips/logs'
...
checkpoint_dir = 'H:/GPU/srgan thesis/25-ESRGAN lpips/training_checkpoints'
...
csv_path = 'H:/GPU/srgan thesis/25-ESRGAN lpips/training_logs4x.csv'
...
save_path = 'H:/GPU/srgan thesis/25-ESRGAN lpips/generator_model.h5'
generator.save(save_path)
print(f"Final generator model saved to {save_path}")
discriminator.save('H:/GPU/srgan thesis/25-ESRGAN lpips/discriminator_model.h5')
