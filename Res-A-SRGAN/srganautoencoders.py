...
log_dir = 'H:/GPU/srgan thesis/8-autoencoder resnet/logs'
...
checkpoint_dir = 'H:/GPU/srgan thesis/8-autoencoder resnet/training_checkpoints'
...
csv_path = 'H:/GPU/srgan thesis/8-autoencoder resnet/training_logs4x.csv'
...
save_path = 'H:/GPU/srgan thesis/8-autoencoder resnet/generator_model.h5'
generator.save(save_path)
print(f"Final generator model saved to {save_path}")
discriminator.save('H:/GPU/srgan thesis/8-autoencoder resnet/discriminator_model.h5')
...
generator = tf.keras.models.load_model('H:/GPU/srgan thesis/8-autoencoder resnet/generator_model.h5')
...
output_dir = 'H:/GPU/srgan thesis/8-autoencoder resnet/generated_hr_images'
