...
def generate_sample_images(epoch, lr_images, hr_images, num_samples=1):
    ...
    for i in range(num_samples):
        ...
        # Save the figure
        sample_dir = 'H:/GPU/srgan thesis/21-lpips resunet/generated_samples'
...
log_dir = 'H:/GPU/srgan thesis/21-lpips resunet/logs'
...
checkpoint_dir = 'H:/GPU/srgan thesis/21-lpips resunet/training_checkpoints'
...
csv_path = 'H:/GPU/srgan thesis/21-lpips resunet/training_logs4x.csv'
