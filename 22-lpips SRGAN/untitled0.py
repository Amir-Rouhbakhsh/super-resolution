...
def generate_sample_images(epoch, lr_images, hr_images, num_samples=1):
    ...
    for i in range(num_samples):
        ...
        # Save the figure
        sample_dir = 'H:/GPU/srgan thesis/22-lpips SRGAN/generated_samples'
...
log_dir = 'H:/GPU/srgan thesis/22-lpips SRGAN/logs'
...
checkpoint_dir = 'H:/GPU/srgan thesis/22-lpips SRGAN/training_checkpoints'
...
csv_path = 'H:/GPU/srgan thesis/22-lpips SRGAN/training_logs4x.csv'
...
save_path = 'H:/GPU/srgan thesis/22-lpips SRGAN/generator_model.h5'
generator.save(save_path)
print(f"Final generator model saved to {save_path}")
discriminator.save('H:/GPU/srgan thesis/22-lpips SRGAN/discriminator_model.h5')
