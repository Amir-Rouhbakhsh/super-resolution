...
def generate_sample_images(epoch, lr_images, hr_images, num_samples=1):
    ...
    for i in range(num_samples):
        ...
        # Save the figure
        sample_dir = 'H:/GPU/srgan thesis/24-res-a-srgan/generated_samples'
...
log_dir = 'H:/GPU/srgan thesis/24-res-a-srgan/logs'
...
checkpoint_dir = 'H:/GPU/srgan thesis/24-res-a-srgan23-lpips a-srgan/training_checkpoints'
...
csv_path = 'H:/GPU/srgan thesis/24-res-a-srgan/training_logs4x.csv'
...
save_path = 'H:/GPU/srgan thesis/24-res-a-srgan/generator_model.h5'
generator.save(save_path)
print(f"Final generator model saved to {save_path}")
discriminator.save('H:/GPU/srgan thesis/24-res-a-srgan/discriminator_model.h5')
